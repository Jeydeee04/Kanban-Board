...
import { FiCalendar, FiFlag, FiCheckSquare, FiTrash2 } from "react-icons/fi"
...
export default function DoneCard({ proj_name, prio, due_date, subtasks, isDarkMode, onDelete }: ExtendedDoneCardProps){
    ...
    return(
        <div className={`${cardBg} rounded-3xl border p-6 shadow-2xs flex flex-col gap-5 w-full opacity-90 transition-colors duration-300 shrink-0`}>
